...
namespace FinalShopOnline.Controllers
{
    ...
    public class ManageProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UploadProductDescription([Bind(Include = "Id,CategoryId,Code,Name,Price,Stock,SmallDescription,Description,Notes,Discount,DisplayPosition,Status,SortOrder,ImageUrl,Unit")]Product product)
        {
            if (ModelState.IsValid)
            {
                product.CreatedDate = System.DateTime.Now;
